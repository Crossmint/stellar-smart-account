...
use crate::auth::signers::{Ed25519Signer, Secp256k1Signer};
...
pub enum Signer {
    ...
    Secp256k1(Secp256k1Signer, SignerRole),
}
...
impl SignatureVerifier for Signer {
    fn verify(&self, env: &Env, payload: &BytesN<32>, proof: &SignerProof) -> Result<(), Error> {
        match self {
            ...
            Signer::Secp256k1(signer, _) => signer.verify(env, payload, proof),
        }
    }
}
...
impl From<Signer> for SignerKey {
    fn from(signer: Signer) -> Self {
        match signer {
            ...
            Signer::Secp256k1(signer, _) => signer.into(),
        }
    }
}
...
impl Signer {
    pub fn role(&self) -> SignerRole {
        match self {
            ...
            Signer::Secp256k1(_, role) => role.clone(),
        }
    }
}
